        ...
        <div className="border-b border-border bg-background px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="h-16 w-16 rounded-lg bg-primary/10 flex items-center justify-center text-xl font-semibold text-primary">
              {concessionaire.logo || concessionaire.name.slice(0, 2)}
            </div>
            <div className="flex-1">
              <h1 className="text-2xl font-semibold">{concessionaire.name}</h1>
              <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground">
                ...
                {concessionaire.website && (
                  <a href={concessionaire.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-primary">
